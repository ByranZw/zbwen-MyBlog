...
!function (a, b) {
    "function" == typeof define && define.amd ? define([], b) : "object" === ("undefined" == typeof exports ? "undefined" : _typeof(exports)) ? module.exports = {init: b.init} : a.ityped = b
}(this, function (a) {
    function b(a) {
        var b = a;
    ...
    var j = void 0, k = void 0, l = document.createElement("span");
    return l.classList.add("ityped-cursor"), l.textContent = "|", {init: c}
}(this));